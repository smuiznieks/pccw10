...
function defineClosure() {
  ...
  console.log(`The book name is: ${myBook.getBookTitle()}`); // closure
  console.log(
    `Accessing myBook's bookName variable directly: ${myBook.bookName}` // not able to access!
  );
  console.log(`Initial Page Number is: ${myBook.getPage()}`);
  myBook.turnPage();
  console.log(
    `New Page Number after changing currentPageNumber with turnPage function: ${myBook.getPage()}`
  );
  ...
  console.log(
    `Accessing myBook's bookName variable directly: ${myBook.bookName}`
  );
  console.log(`Initial Page Number is: ${myBook.getPage()}`);
  myBook.turnPage();
  console.log(
